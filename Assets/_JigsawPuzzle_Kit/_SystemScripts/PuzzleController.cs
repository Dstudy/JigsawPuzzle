...
public class PuzzleController : MonoBehaviour
{
    ...
    public bool enablePositionSaving = false;
    ...
    public bool assembleInAnyPlace = true;
    ...
    public float groupingDistance = 1.5f;
    ...
    public PuzzlePieceGroup currentGroup = null;
    ...
    public PuzzleState ProcessPuzzle (Vector3 _pointerPosition, bool _dragInput, float _rotationDirection)
    {
        ...
        if (currentPiece < 0) return PuzzleState.None;
